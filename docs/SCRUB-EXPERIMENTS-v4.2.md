# Credential Exposure Experiments (v4.2)
...
**Observation:** Same baseline code, different results across runs. Run 1 showed scrubbed output. Run 2 showed raw token. Behavior is INTERMITTENT.
